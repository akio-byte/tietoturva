...
const Routines: React.FC = () => {
  const routineItems = Object.values(contentRegistry).filter(item => item.category === 'routines');
      ...
      <div className="space-y-12">
        <div className="glass p-8 rounded-3xl border border-slate-800">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-slate-500">Sisältökirjasto</p>
              <h2 className="text-2xl font-black text-white">Rutiinien syventävät sisällöt</h2>
            </div>
            <span className="text-xs font-bold uppercase tracking-widest text-emerald-400">
              {routineItems.length} sisältöä
            </span>
          </div>
